...
<head>
  ...
  <link rel="styleshhet" href="${pageContext.request.contextPath}/main_resource/css/storemain.css">
</head>
<body>
	...
	<table border="1">
		...
		<c:forEach items="${list }" var="product"> 
			<tr>
				...
				<td><a href="detailAction.do?seq=${product.product_seq}">${product.product_name }</a></td>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-product__price">${product.product_price }원</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
