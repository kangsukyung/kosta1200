...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/main_resource/css/storemain.css">  
</head>
<body>
            ...
            <div class="row row_product_hw col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    ...
                    <h4 class="card-product__title"><a href="StoreDetailAction.do?board_seq=${board.board_seq}">${board.board_title }</a></h4>
                    <p class="card-product__price">${board.board_views }회 조회</p>
                  </div>
                </div>
            </div>
            </c:forEach>
